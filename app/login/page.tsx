...
export default function LoginPage() {
  ...
  const productIcons = [
    <path
      key="1"
      d="M19 8h-1V7c0-3.31-2.69-6-6-6S6 3.69 6 7v1H5c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM8 7c0-2.21 1.79-4 4-4s4 1.79 4 4v1H8V7z"
    />,
    <path
      key="2"
    ...
    <path
      key="3"
      d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-5 14H9v-2h6v2zm1.1-5H7.9l-1-2h10.2l-1 2z"
    />,
    <path
      key="4"
      d="M21.41 11.58l-9-9C12.05 2.22 11.55 2 11 2H4c-1.1 0-2 .9-2 2v7c0 .55.22 1.05.59 1.42l9 9c.36.36.86.58 1.41.58s1.05-.22 1.42-.59l7-7c.37-.36.59-.86.59-1.42s-.22-1.06-.59-1.41zM5.5 8C4.67 8 4 7.33 4 6.5S4.67 5 5.5 5 7 5.67 7 6.5 6.33 8 5.5 8z"
    />,
    <path
      key="5"
      d="M17.21 9l-4.38-6.56c-.19-.28-.51-.42-.83-.42s-.64.14-.83.43L6.79 9H2c-.55 0-1 .45-1 1 0 .09.01.18.04.27l2.54 9.27c.23.84 1 1.46 1.92 1.46h13c.92 0 1.69-.62 1.93-1.46l2.54-9.27L23 10c0-.55-.45-1-1-1h-4.79zM9 9l3-4.4L15 9H9z"
    />,
  ];
        ...
        >
          <div className="flex items-center gap-3 mb-16">
            ...
            <h1 className="text-xl font-black text-slate-800 tracking-tighter">
              MiniPOS <span className="text-blue-500">MTZ</span>
            </h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                type="email"
                value={email}
                placeholder="admin@minipos.cl"
                onChange={(e) => setEmail(e.target.value)}
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 focus:bg-white focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 outline-none transition-all text-slate-700 font-medium"
                required
              />
            </div>
            ...
            <div className="flex items-center justify-between py-1">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  ...
                  className="w-5 h-5 rounded-lg border-slate-300 text-blue-600 focus:ring-blue-500 transition-all cursor-pointer accent-blue-600"
                />
                <span className="text-xs text-slate-500 font-bold group-hover:text-slate-700 transition-colors">
                  Recordarme
                </span>
              </label>
              <button
            ...
            <button
              ...
              className="w-full bg-[#1E3A5F] hover:bg-blue-600 text-white font-black py-5 rounded-2xl transition-all shadow-xl shadow-blue-900/10 active:scale-[0.98] disabled:opacity-50 text-sm uppercase tracking-widest"
            >
